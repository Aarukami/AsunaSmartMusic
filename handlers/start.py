        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "🛠 Repo", url="https://github.com/zYxDevs/AsunaSmartMusic"
                    ),
                ],
            ]
        ),
...
/userbotjoin - To Invite assistant on your chat
/userbotleave - To Kick assistant from your chat
/reload - To refresh admin list
</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("Group", url="https://t.me/YBotsSupport"),
                    InlineKeyboardButton("Updates", url="https://t.me/SpreadNetworks"),
                ]
            ]
        ),
    )
