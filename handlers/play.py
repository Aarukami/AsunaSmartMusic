...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    font = ImageFont.truetype("etc/SAOWelcome-Regular.otf", 32)
...
#endtest
@Client.on_message(command(["play", f"play@{BOT_USERNAME}", "aplay"]) 
                   & filters.group
                   & ~filters.edited 
                   & ~filters.forwarded
                   & ~filters.via_bot)
            ...
            [
                [
                    InlineKeyboardButton(
                        text="🚨 Support", url="https://t.me/YBotsSupport"
                    ),
                    InlineKeyboardButton(
                        text="Channel 🔊", url="https://t.me/SpreadNetworks"
                    ),
                ]
            ]
        )
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="Updates 📡", url="https://t.me/SpreadNetworks"
                        ),
                    ],
                    [
